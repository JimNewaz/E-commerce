...
// code for Shipping address updation
	...
	{	
		...
		$address_lin2=$_POST['address_line2'];
		$sstate=$_POST['shippingstate'];
		$scity=$_POST['shippingcity'];
		$spincode=$_POST['shippingpincode'];
		$contactno=$_POST['contactno'];
		$query=mysqli_query($con,"update users set name='$name', shippingAddress='$saddress',shippingState='$sstate',shippingCity='$scity',shippingPincode='$spincode',contactno='$contactno',address_line2='$address_lin2'  where id='".$_SESSION['id']."'");
		if($query)
		{
...
?>
					...
					<div class="form-group">
					    <label class="info-title" for="Shipping Address">Name<span>*</span></label>
					    <textarea class="form-control unicase-form-control text-input" name="name" required="required"><?php echo $row['name'];?></textarea>
					</div>


					<div class="form-group">
					    <label class="info-title" for="Shipping Address">Address Line 1<span>*</span></label>
					...
					<div class="form-group">
					    <label class="info-title" for="Address Line 2">Address Line 2<span>*</span></label>
					    <textarea class="form-control unicase-form-control text-input" name="address_line2" required="required"><?php echo $row['address_line2'];?></textarea>
					</div>

						
					  <div class="form-group">
					    <label class="info-title" for="Shipping City">City/Town <span>*</span></label>
					  ...
					  <div class="form-group">
					    <label class="info-title" for="Shipping State ">Country  <span>*</span></label>
 					...
 					<div class="form-group">
					    <label class="info-title" for="Shipping Pincode">Postcode <span>*</span></label>
					...
					<div class="form-group">
					    ...
					    <input type="text" class="form-control unicase-form-control text-input" id="contactno" name="contactno" required="required" value="<?php echo $row['contactno'];?>"  maxlength="20">
					</div>
