...
$sql=mysqli_query($con,"update  products set category='$category',subCategory='$subcat',procondition='$productcondition',productName='$productname',productCompany='$productcompany',productPrice='$productprice',productDescription='$productdescription',shippingCharge='$productscharge',productAvailability='$productavailability',stock='$productstock',featured='$productfeatured',productPriceBeforeDiscount='$productpricebd' where id='$pid' ");
...
<!--<option value="<?php echo htmlentities($row['procondition']);?>"></option>-->
<input type="radio" name="productcondition" id="productcondition" <?php if($row['procondition']=="New") echo "checked";?> value="New">New <br>
<input type="radio" name="productcondition" id="productcondition" <?php if($row['procondition']=="Used A(Mint)") echo "checked";?> value="Used A(Mint)">Used A(Mint) <br>
<input type="radio" name="productcondition" id="productcondition" <?php if($row['procondition']=="Used B(Good)") echo "checked";?> value="Used B(Good)">Used B(Good) <br>
<input type="radio" name="productcondition" id="productcondition" <?php if($row['procondition']=="Used C(Fair)") echo "checked";?> value="Used C(Fair)">Used C(Fair) <br>

<!--<option value="New">New</option>-->
<!--<option value="Used A(Mint)">Used A(Mint)</option>-->
<!--<option value="Used B(Good)">Used B(Good)</option>-->
<!--<option value="Used C(Fair)">Used C(Fair)</option>-->
...
<div class="controls">
<input type="text"    name="stock"  placeholder="Enter No Of Stock" value="<?php echo htmlentities($row['stock']);?>" class="span8 tip" >
</div>
</div>
...
<input type="radio" name="productfeatured" id="productfeatured" <?php if($row['featured']=="yes") echo "checked";?> value="yes">Yes <br>
<input type="radio" name="productfeatured" id="productfeatured" <?php if($row['featured']=="no") echo "checked";?> value="no">No
...
<img src="productimages/<?php echo htmlentities($pid);?>/<?php echo htmlentities($row['productImage1']);?>" width="200" height="100"> <a href="update-image1.php?id=<?php echo $row['id'];?>">Change Image</a> &nbsp; &nbsp;
    <a href="removeimg1.php?id=<?php echo $row['id'];?>">Remove Image</a>
</div>
</div>
