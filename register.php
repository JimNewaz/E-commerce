...
if(isset($_POST['submit']))
{
    ...
    $query=mysqli_query($con,"insert into users(name,email,contactno,password,token,shippingAddress,shippingCity,shippingPincode) values('$name','$email','$contactno','$password','$token','$address','$city','$postcode')");
    if($query)
    {
...
<head>
  ...
  <title>Softly Software | Sign Up</title>
      ...
      <div class="sign-in-page inner-bottom-sm">
        <div class="row">
          ...
          <div class="col-md-6 create-new-account" style="border:1px solid #DDDDDD; padding: 20px;">
            ...
            <a href="login.php" class="forgot-password pull-left">Already have an account? Click Here</a> <br>
            ...
            <form class="register-form outer-top-xs" role="form" method="post" name="register"
              ...
              <div class="form-group">
                <label class="info-title" for="address">First Line of Address <span>*</span></label>
                <input type="text" class="form-control unicase-form-control text-input" id="address" name="address"
                  required="required">
              </div>
              
              <div class="form-group">
                <label class="info-title" for="city">Town/City <span>*</span></label>
                <input type="text" class="form-control unicase-form-control text-input" id="city" name="city"
                  required="required">
              </div>
              
              <div class="form-group">
               <label class="info-title" for="postcode">Postcode<span style="color:red;">*</span></label>
                  <input type="text" class="form-control unicase-form-control text-input" id="postcode" name="postcode" required>
              </div>
              ...
              <div class="form-group">
                ...
                <input type="password" class="form-control unicase-form-control text-input" id="confirmpassword"
