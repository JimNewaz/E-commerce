...
if(isset($_POST['change']))
{
    ...
    // if($num>0)
    // {
        $extra="recover-password.php";
        mysqli_query($con,"update users set password='$password' WHERE token='$token'");
...
<html lang="en">
	<head>
	    ...
	    <title>Game Stocker | Recover_Password</title>
	...
	<div class="container">
		<div class="sign-in-page inner-bottom-sm">
			<div class="row">
				...
				<!-- Sign-in -->			
<div class="col-md-6 col-sm-6 sign-in" style="border:1px solid #DDDDDD" >
	<h4 class="" style="text-align:center">Forgot password</h4>
	<form class="register-form outer-top-xs" name="register" method="post" style="padding:20px;">
